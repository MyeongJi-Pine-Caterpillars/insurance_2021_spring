            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<div class="row">
						...
						<form id="form-rateDentalInsurance" action="goToGuaranteeDentalInsurance" method="get">
							<!-- Illustrations -->
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">연간 한도 횟수</h6>
								</div>
								<div class="card-body">
									<div class="column">
									<div class = "form-check">
										<div class="row">
											...
											<div class=form-check>
												<input type="number" name="annualCount" value="0"> 
											</div>
										</div>
									</div>
							...
							<script>
							function nextBtn(){
								$("#form-rateDentalInsurance").submit();
							}
							</script>
						</div>
					</div>
