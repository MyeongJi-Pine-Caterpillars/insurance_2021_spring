                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                       ...
                       <li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false">
								<button type="button"
									onclick="location.href='developInsurance/doLogout'"
                ...
                <div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-lg-6 mb-4">
									...
									<div class="column">
											<div class=form-check>
												<input class="form-check-input" type="checkbox"
													name="genderCheckbox" value="man"> <label
													class="form-check-label" for="genderCheckbox1">남자</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="checkbox"
													name="genderCheckbox" value="woman"> <label
										...
										<div id="genderAlarm" style="display: none;">
											<div
												...
												<div>&nbsp 최소 하나의 성별을 선택해주세요!!</div>
											</div>
										</div>
									</div>
							</div>
							...
							<script>
							function next(){
								if ($(':checkbox[name="genderCheckbox"]:checked').length < 1) {
									$('#genderAlarm').show();
								} else {
									$("#form-insurance").submit();
								}
							}
							$("input:checkbox[name=genderCheckbox]").click(function() {
								$('#genderAlarm').hide();
							});
							</script>
						</div>
