...
<%@ page import="com.insurance.sce.model.insurance.DentalInsurance"%>
<%
	List<DentalInsurance> insuranceList = (List<DentalInsurance>)request.getAttribute("insuranceList");
%>
				...
				<nav
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false">
								<button type="button"
									onclick="location.href='selectDentalInsurance/doLogout'"
