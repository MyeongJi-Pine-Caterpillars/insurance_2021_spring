...
<%@ page import="com.insurance.sce.model.insurance.TripInsurance"%>
<%
	List<TripInsurance> insuranceList = (List<TripInsurance>)request.getAttribute("insuranceList");
%>
			...
			<div id="content">
				...
				<nav
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false">
								<button type="button"
									onclick="location.href='selectTripInsurance/doLogout'"
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">여행자보험</h1>
					</div>
							...
							<div class="col-lg-6 mb-4">
								...
								<div class="card shadow mb-4">
									...
									<div class="row">
										...
										<div class="col" id="rateOfGender"></div>
									</div>
									<div class="row">
										<div class="col mb-3" id="rateOfCountryRisk"></div>
										<div class="col"></div>
									</div>
									</div>
								</div>
			...
			$('.col-xl-3').click(function(){
				...
				$.ajax({
					...
					success : function(data){
						...
						$('#rateOfCountryRisk').html('<div class="col mb-3" id="rateOfGender"><h4 class="small font-weight-bold">--국가위험등급 요율표--</h4></div>');
						$.each(data.rateOfCountryRank, function(index, item){
							$('#rateOfCountryRisk').append(
									'<h4 class="small font-weight-bold">'+ countryRisk[index] +'<span class="float-right">' +
										item +
										'&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span></h4>'
							);
						});
				...
				$.ajax({
					url: "selectTripInsurance/doSelectGuaranteePlan",
					type: "GET",
					data: insuranceId,
