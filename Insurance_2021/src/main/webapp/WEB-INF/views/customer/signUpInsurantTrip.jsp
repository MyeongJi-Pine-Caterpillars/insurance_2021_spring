...
<body id="page-top">
					...
					<div class="row">
						...
						<div class="col-lg-6 mb-4">
							<form name="formSignUpInsurant"
								action="doRegisterTripInsurance" method="get">

								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h6 class="m-0 font-weight-bold text-primary">국가 위험도</h6>
									</div>
									<div class="card-body">
										<div class="column">
											<div class="form-check">
												<div class="col">
													<label>여행하는 국가의 위험도를 선택해주세요</label>
													<div class="col">
														<div class="row">
															<div class=form-check>
																<input class="form-check-input" type="radio"
																	name="rateOfCountryRiskRadio" value="Zero"> <label
																	class="form-check-label" for="insuranceRadio1">
																	안전&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio"
																	name="rateOfCountryRiskRadio" value="One"> <label
																	class="form-check-label" for="insuranceRadio2">
																	1단계&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio"
																	name="rateOfCountryRiskRadio" value="Two"> <label
																	class="form-check-label" for="insuranceRadio2">
																	2단계&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
															</div>
															<div class="form-check">
																<input class="form-check-input" type="radio"
																	name="rateOfCountryRiskRadio" value="Three"> <label
																	class="form-check-label" for="insuranceRadio2">
																	3단계&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>
															</div>
														</div>
													</div>
												</div>
											...
											<div id="rateOfCountryRiskAlarm" style="display: none;">
												<div
	...
	<script>
		function checkInput() {
			...
			if ($(':radio[name="rateOfCountryRiskRadio"]:checked').length < 1) {
				$('#rateOfCountryRiskAlarm').show();
			} else {
				form.submit();
			}
		}

		$("input:radio[name=rateOfCountryRiskRadio]").click(function() {
			$('#rateOfCountryRiskAlarm').hide();
		});
	</script>
