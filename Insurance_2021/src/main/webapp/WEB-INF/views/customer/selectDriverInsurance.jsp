...
<%@ page import="com.insurance.sce.model.insurance.DriverInsurance"%>
<%
	List<DriverInsurance> insuranceList = (List<DriverInsurance>)request.getAttribute("insuranceList");
%>
			...
			<div id="content">
				...
				<nav
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false">
								<button type="button"
									onclick="location.href='selectDriverInsurance/doLogout'"
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">운전자보험</h1>
					</div>
			...
			$('.col-xl-3').click(function(){
				...
				$.ajax({
					...
					success : function(data){
						...
						$('#rateOfCarType').html('<div class="col mb-3" id="rateOfGender"><h4 class="small font-weight-bold">--자동차 종류 요율표--</h4></div>');
						$.each(data.rateOfCarType, function(index, item){
							$('#rateOfCarType').append(
									'<h4 class="small font-weight-bold">'+ carType[index] +'<span class="float-right">' +
										item +
										'&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span></h4>'
							);
						});
						$('#rateOfCarRank').html('<div class="col mb-3" id="rateOfGender"><h4 class="small font-weight-bold">--자동차 등급 요율표--</h4></div>');
						$.each(data.rateOfCarRank, function(index, item){
							$('#rateOfCarRank').append(
									'<h4 class="small font-weight-bold">'+ carRank[index] +'<span class="float-right">' +
										item +
										'&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span></h4>'
							);
						});
						$('#rateOfAccidentHistory').html('<div class="col mb-3" id="rateOfGender"><h4 class="small font-weight-bold">--사고횟수 요율표--</h4></div>');
