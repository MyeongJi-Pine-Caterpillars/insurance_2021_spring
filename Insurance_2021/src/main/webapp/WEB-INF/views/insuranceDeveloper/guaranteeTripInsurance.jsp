            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                       ...
                       <li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false">
								<button type="button"
									onclick="location.href='guaranteeTripInsurance/doLogout'"
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">여행자 보험 보장 내역 설정하기</h1>
					</div>
					<!-- /.row -->
					<!-- Content Row -->
					<form id="form-guaranteeTripInsurance" action="checkTripInsurance" method="get">
					<div class="row">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												...
												보장 내역 1</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><%= request.getAttribute("tripGuarantee1") %></div>
										</div>
										<div class="col mr-2">
										...
										<div class="row no-gutters align-items-center">
											...
											<input style="zoom:1.5" class="form-check-input" type="checkbox"
												name="guaranteeCheckbox" value="사망">
										</div>
										<div class="row no-gutters align-items-center">
											<input style="display:none" class="form-check-input" type="checkbox"
												name="specialCheckbox" id="special1" value="사망">
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												보장 내역 2</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><%= request.getAttribute("tripGuarantee2") %></div>
										</div>
										<div class="col mr-2">
										...
										<div class="row no-gutters align-items-center">
											...
											<input style="zoom:1.5" class="form-check-input" type="checkbox"
												name="guaranteeCheckbox" value="상해">
										</div>
										<div class="row no-gutters align-items-center">
											<input style="display:none" class="form-check-input" type="checkbox"
												name="specialCheckbox" id="special2" value="상해">
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												보장 내역 3</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><%= request.getAttribute("tripGuarantee3") %></div>
										</div>
										<div class="col mr-2">
										...
										<div class="row no-gutters align-items-center">
											...
											<input style="zoom:1.5" class="form-check-input" type="checkbox"
												name="guaranteeCheckbox" value="해외의료비">
										</div>
										<div class="row no-gutters align-items-center">
											<input style="display:none" class="form-check-input" type="checkbox"
												name="specialCheckbox" id="special3" value="해외의료비">
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												보장 내역 4</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><%=request.getAttribute("tripGuarantee4")%></div>
										</div>
										<div class="col mr-2">
										...
										<div class="row no-gutters align-items-center">
											...
											<input style="zoom:1.5" class="form-check-input" type="checkbox"
												name="guaranteeCheckbox" value="휴대품손해">
										</div>
										<div class="row no-gutters align-items-center">
											<input style="display:none" class="form-check-input" type="checkbox"
												name="specialCheckbox" id="special4" value="휴대품손해">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="row">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												보장 내역 5</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><%= request.getAttribute("tripGuarantee5") %></div>
										</div>
										<div class="col mr-2">
										...
										<div class="row no-gutters align-items-center">
											...
											<input style="zoom:1.5" class="form-check-input" type="checkbox"
												name="guaranteeCheckbox" value="배상책임">
										</div>
										<div class="row no-gutters align-items-center">
											<input style="display:none" class="form-check-input" type="checkbox"
												name="specialCheckbox" id="special5" value="배상책임">
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">
												보장 내역 6</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><%= request.getAttribute("tripGuarantee6") %></div>
										</div>
										<div class="col mr-2">
										...
										<div class="row no-gutters align-items-center">
											...
											<input style="zoom:1.5" class="form-check-input" type="checkbox"
												name="guaranteeCheckbox" value="항공기납치">
										</div>
										<div class="row no-gutters align-items-center">
											<input style="display:none" class="form-check-input" type="checkbox"
												name="specialCheckbox" id="special6" value="항공기납치">
										</div>
									</div>
								</div>
							</div>
						...
						<script>
							function nextBtn(){
								$("#form-guaranteeTripInsurance").submit();
